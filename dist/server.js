...
// Milling functions
submitMillingToSolana, checkMillingExistsOnSolana, getMillingFromSolana, updateMillingOnSolana, deleteMillingOnSolana, closeMillingOnSolana, 
// Season functions
...
// Buyback functions
submitBuybackToSolana, checkBuybackExistsOnSolana, getBuybackFromSolana, updateInSeasonOnSolana, settleBuybackOnSolana, confirmBuybackPaymentOnSolana, deleteBuybackOnSolana, closeBuybackOnSolana, 
// Admin functions
...
app.get('/api/v1/get-actor/:actorId', verifyHmac, async (req, res) => {
    try {
        const actorIdParam = req.params.actorId;
        if (!actorIdParam) {
            return res.status(400).json({ success: false, error: 'Actor ID parameter is required' });
...
app.post('/api/v1/close-actor', verifyHmac, async (req, res) => {
    try {
        const actorData = req.body;
...
app.post('/api/v1/submit-drying', verifyHmac, async (req, res) => {
    try {
...
app.get('/api/v1/check-drying/:dryingId', verifyHmac, async (req, res) => {
    try {
...
app.get('/api/v1/get-drying/:dryingId', verifyHmac, async (req, res) => {
    try {
        const dryingIdParam = req.params.dryingId;
        if (!dryingIdParam) {
            return res.status(400).json({
...
app.post('/api/v1/update-drying', verifyHmac, async (req, res) => {
    try {
        const dryingData = req.body;
...
app.post('/api/v1/delete-drying', verifyHmac, async (req, res) => {
    try {
        const dryingData = req.body;
...
app.post('/api/v1/close-drying', verifyHmac, async (req, res) => {
    try {
        const dryingData = req.body;
...
app.post('/api/v1/submit-milling', verifyHmac, async (req, res) => {
    try {
...
app.get('/api/v1/check-milling/:millingId', verifyHmac, async (req, res) => {
    try {
...
app.get('/api/v1/milling/:millingId', verifyHmac, async (req, res) => {
    try {
        const millingIdParam = req.params.millingId;
        if (!millingIdParam) {
            return res.status(400).json({
...
app.put('/api/v1/milling/:millingId', verifyHmac, async (req, res) => {
    try {
        const millingIdParam = req.params.millingId;
...
app.delete('/api/v1/milling/:millingId', verifyHmac, async (req, res) => {
    try {
        const millingIdParam = req.params.millingId;
        if (!millingIdParam) {
            return res.status(400).json({
...
app.delete('/api/v1/milling/:millingId/close', verifyHmac, async (req, res) => {
    try {
        const millingIdParam = req.params.millingId;
        if (!millingIdParam) {
            return res.status(400).json({
...
app.post('/api/v1/submit-transaction', verifyHmac, async (req, res) => {
    try {
...
app.get('/api/v1/check-transaction/:nonce', verifyHmac, async (req, res) => {
    try {
...
app.post('/api/v1/submit-buyback', verifyHmac, async (req, res) => {
    try {
...
app.get('/api/v1/check-buyback/:buybackId', verifyHmac, async (req, res) => {
    try {
...
app.get('/api/v1/get-buyback/:buybackId', verifyHmac, async (req, res) => {
    try {
        const buybackIdParam = req.params.buybackId;
        if (!buybackIdParam) {
            return res.status(400).json({
...
app.post('/api/v1/update-in-season', verifyHmac, async (req, res) => {
    try {
        const buybackData = req.body;
...
app.post('/api/v1/settle-buyback', verifyHmac, async (req, res) => {
    try {
        const buybackData = req.body;
...
app.post('/api/v1/confirm-buyback-payment', verifyHmac, async (req, res) => {
    try {
        const buybackData = req.body;
...
app.post('/api/v1/delete-buyback', verifyHmac, async (req, res) => {
    try {
        const buybackData = req.body;
...
app.post('/api/v1/close-buyback', verifyHmac, async (req, res) => {
    try {
        const buybackData = req.body;
