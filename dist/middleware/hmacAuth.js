...
export function hmacSigningInput(req, timestamp, nonce) {
    return `${req.method.toUpperCase()}\n${req.originalUrl}\n${timestamp}\n${nonce}\n${req.rawBody ?? ""}`;
}
export const verifyHmac = (req, res, next) => {
    const developmentBypass = process.env.SKIP_HMAC_AUTH === "true" &&
...
export function clearHmacNonceCacheForTests() {
