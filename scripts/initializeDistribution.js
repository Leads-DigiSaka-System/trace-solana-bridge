...
async function main() {
    ...
    const idlPath = "./src/idl/distribution.json";
    const idl = JSON.parse(readFileSync(idlPath, "utf8"));
    const programId = new PublicKey(process.env.SOLANA_DISTRIBUTION_PROGRAM_ID);
    ...
    console.log("Distribution Program ID:", programId.toBase58());
    ...
    if (accountInfo) {
        console.log("✅ bridge_config is already initialized.");
        return;
    }
